    ...
    if(!body.name || !body.description){
        ...
        .then(updated => {
            if(updated){
                ...
                res.status(404).json({message: "We couldn't find the project your looking to update."})
            }
        })
...
router.get('/:id', (req, res) => {
    ...
    .catch(err => res.status(500).json({message: "There was an error getting this project"}))
})
